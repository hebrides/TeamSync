...
{
  TSConnection* connection = [[[TSConnection alloc] initWithNativeSocketHandle:nativeSocketHandle] autorelease];
...
- (BOOL) publishService
{
    ...
    NSString* chatRoomName = [NSString stringWithFormat:@"%@/%@", [[TSAppConfig getInstance] name],[[TSAppConfig getInstance] type]];
    // create new instance of netService
 	self.netService = [[NSNetService alloc]
                       initWithDomain:@"" type:@"_teamSync._tcp."
...
- (void)netService:(NSNetService*)sender didNotPublish:(NSDictionary*)errorDict
{
  ...
  [delegate serverFailed:self reason:@"Master with same name already exists."];
}
