...
// Description		:	TSConnection class Declaration.
...
@interface TSConnection : NSObject <NSNetServiceDelegate>
{
  id<TSConnectionDelegate> delegate;
...
@property(nonatomic,retain) id<TSConnectionDelegate> delegate;
